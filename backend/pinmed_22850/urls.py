"""pinmed_22850 URL Configuration
...
admin.site.site_header = "pinmed"
admin.site.site_title = "pinmed Admin Portal"
admin.site.index_title = "pinmed Admin"

# swagger
api_info = openapi.Info(
    title="pinmed API",
    default_version="v1",
    description="API documentation for pinmed App",
)
